...
<body>
    ...
    <div class="bg-light">
        <div class="container py-5">
            ...
            <p class="mb-4">
                This privacy policy sets out how our website uses and protects any information that you give us when you
                use this website.
            </p>
            ...
            <h2 class="h2 fw-bold mb-2">How We Use the Information</h2>
            ...
            <ul class="mb-4 ps-3">
                ...
                <li>From time to time, we may also use your information to contact you for market research purposes. We
                    may contact you by email, phone, or mail. We may use the information to customize the website
                    according to your interests.</li>
            </ul>

            <h2 class="h2 fw-bold mb-2">Security</h2>
            ...
            <h2 class="h2 fw-bold mb-2">Links to Other Websites</h2>
            ...
            <h2 class="h2 fw-bold mb-2">Controlling Your Personal Information</h2>
            ...
            <ul class="mb-4 ps-3">
                <li>If you have previously agreed to us using your personal information for direct marketing purposes,
                    you may change your mind at any time by writing to or emailing us at [email protected]</li>
                <li>We will not sell, distribute, or lease your personal information to third parties unless we have
                    ...
                    that you wish this to happen.</li>
                <li>You may request details of personal information which we hold about you. If you would like a copy of
                    the information held on you, please write to [Your Company Name, Address, City, State, Zip Code] or
