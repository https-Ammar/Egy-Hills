               ...
               <tr id="row-11">
                                ...
                                <td>
                                     ...
                                     <?php if ($director['image']): ?>
                                           <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center"
                                            style="background-image: url(/Egy-Hills/uploads/<?= $director['image'] ?>)">
                                        </div>
                ...
                <?php endif; ?>
                                ...
                                <td>
                        <?= nl2br(htmlspecialchars($director['text'])) ?>
                                </td>
                            ...
                            <a href="?delete_director_card=<?= $director['id'] ?>">
                                           <button  onclick="return confirm('Are you sure?')" class="btn btn-soft-danger btn-sm">
                                            <iconify-icon icon="solar:trash-bin-minimalistic-2-broken"
                                                class="align-middle fs-18"></iconify-icon>
                                        </button>
                                 </a>
            ...
            <div>
                <div class="table-responsive">
                    <table class="table align-middle mb-0 table-hover table-centered">
                        ...
                        target="_blank"><?= htmlspecialchars($row['link']) ?></a> 0 Reviews
                                </td>
                                <td>
                                    <div class="d-flex gap-2">
